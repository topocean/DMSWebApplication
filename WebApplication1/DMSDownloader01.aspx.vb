...
Public Class DMSDownloader01
    ...
    Private Sub bindGridView()
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                G1.DataSource = ds
                G1.DataBind()
                'temp = ds.Tables(0).Rows(0).Item("FullFileName").ToString
                ds.Clear()
            Else
    ...
    Private Sub BindDropDown()
        ...
        Try
            ...
            Dim cmd1 As New SqlCommand("SELECT distinct DestOffice FROM BookingInfo WHERE DestOffice <> '' Order by DestOffice", DMSConn)
            ...
            For Each ctl As Control In Form.Controls
                If TypeOf ctl Is DropDownList Then
                    If ctl.ID.IndexOf("agt") >= 0 Then
                        Dim dl As DropDownList = CType(ctl, DropDownList)

                        dl.Items.Clear()

                        For i = 0 To ds1.Tables(0).Rows.Count - 1
                            dl.Items.Add(New ListItem(ds1.Tables(0).Rows(i).Item("DestOffice"), ds1.Tables(0).Rows(i).Item("DestOffice")))
                        Next
                    End If
                End If
            Next
    ...
    Private Sub UpdateDMS(ByVal FileType As String, ByVal AgtCode As String, ByVal FileName As String)
        ...
        Dim c8 As New SqlParameter("@Office", Data.SqlDbType.VarChar)
        Dim c9 As New SqlParameter("@BkhRefId", Data.SqlDbType.Int)
        ...
        Try
            ...
            Dim cmd As New SqlCommand("usp_FileInfo_UploadUpdateDMS", DMSConn)
    ...
    Private Sub UploadFile(ByVal FileType As String, ByVal AgtCode As String, FU As FileUpload, ByVal DestFile As String)
        ...
        If Not String.IsNullOrEmpty(FU.FileName) Then
            ...
            UpdateDMS(FileType, AgtCode, fname)
        End If
    ...
    Private Sub bunUpload_Click1(sender As Object, e As EventArgs) Handles bunUpload.Click
        ...
        For i = 1 To 5
            ...
            If UploadFileType = "FL" Then
                agd1 = Me.FindControl(String.Format("agt{0}", i))
                UploadAgtCode = agd1.SelectedItem.Value
            Else
                UploadAgtCode = ""
            End If
            ...
            If UploadFileName <> "" Then
                ...
                DestFileName = String.Format("{0}{1}\{2}_{3}", UploadRoot, UploadFileType, DestFileFormat.Replace("$H$", newHBL).Replace("$M$", newMBL).Replace("$A$", UploadAgtCode), DateTime.UtcNow.Ticks)

                UploadFile(UploadFileType, UploadAgtCode, fnup, DestFileName)
            End If
