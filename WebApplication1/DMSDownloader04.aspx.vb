...
Public Class DMSDownloader04
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        SupplierInvNo = Request.QueryString("suppIme")
        ...
        If Not Page.IsPostBack Then
            ...
            txt_hblno.Text = HBL
            txt_mblno.Text = MBL
            txt_username.Text = DMSloginUser
    ...
    Private Sub bindGridView()
        ...
        'Try
        '    Dim cmd As New SqlCommand("usp_FileInfo_SPISearch", DMSConn)
    ...
    Private Sub BindDropDown()
        ...
        Try
            ...
            supp1.Text = SupplierInvNo.ToString().Trim()
    ...
    Private Sub UpdateDMS(ByVal FileName As String)

        Dim c1 As New SqlParameter("@FileName", Data.SqlDbType.VarChar)
        Dim c2 As New SqlParameter("@SuppIme", Data.SqlDbType.VarChar)
        Dim c3 As New SqlParameter("@UserBrh", Data.SqlDbType.VarChar)
        ...
        Try
            ...
            Dim cmd As New SqlCommand("usp_FileInfo_SPIUploadUpdate", DMSConn)

            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandTimeout = 900

            c1.Value = FileName
            c2.Value = SupplierInvNo
            c3.Value = Office
    ...
    Private Sub bunUpload_Click1(sender As Object, e As EventArgs) Handles bunUpload.Click
        ...
        For i = 1 To 5
            ...
            If UploadFileName <> "" Then
                ...
                DestFileFormat = "SPI"
                DestFileName = String.Format("{0}{1}\{2}_{3}_{4}_{5}", UploadRoot, UploadFileType, DestFileFormat, Office, SupplierInvNo.Replace("\", "-").Replace("/", "-"), DateTime.Now.ToString("yyyyMMddhhmmss"))
