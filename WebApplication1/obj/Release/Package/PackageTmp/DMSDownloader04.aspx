<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DMSDownloader04.aspx.vb" Inherits="WebApplication1.DMSDownloader04" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="upblk">
            ...
            <div id="tabs">
                <ul>
                    <li><a href="#upd1">Uploader</a></li>
                    <li style="display:none;"><a href="#upd2">Drag&Drop Uploader</a></li>
                </ul>
                <div id="upd1">
                    <table style="width: 100%;">
                        <tr>
                                        ...
                                        <td>
                                            <table class="upfile" style="width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center>
                                                        <asp:Label ID="supp1" runat="server"></asp:Label>
                                                        </center>
                                                        <asp:DropDownList ID="agt1" runat="server" style="display:none;"></asp:DropDownList>
                                                    </td>
                                                    <td>
        ...
        <script type="text/javascript">
            ...
            function filetypeHelper(ft) {
                ...
                $(su).css("display", (ft[0].selectedIndex > 0 ? "" : "none"));
            };
